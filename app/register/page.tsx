...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (signInRes?.error) { setError("Registered but sign-in failed. Please log in."); setLoading(false); return; }
    router.push("/app");
  };
      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 mb-4">
            ...
            <span className="font-bold text-gray-900">DataBridge</span>
          </Link>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm space-y-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <button type="submit" disabled={loading}
              className="w-full bg-blue-600 text-white py-2.5 rounded-xl font-semibold text-sm hover:bg-blue-700 disabled:opacity-60 transition-colors">
